...
func easyjsonF0e85041DecodeMevericcoreMcws(in *jlexer.Lexer, out *WsRPCMsgBaseSt) {
...
func easyjsonF0e85041EncodeMevericcoreMcws(out *jwriter.Writer, in WsRPCMsgBaseSt) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Src != "" {
