...
func easyjsonD2b7633eDecodeMevericcoreMcdevicemqttmanager(in *jlexer.Lexer, out *RPCMsg) {
...
func easyjsonD2b7633eEncodeMevericcoreMcdevicemqttmanager(out *jwriter.Writer, in RPCMsg) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Src != "" {
...
func (v RPCMsg) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD2b7633eEncodeMevericcoreMcdevicemqttmanager(&w, v)
...
func (v *RPCMsg) UnmarshalJSON(data []byte) error {
	...
	easyjsonD2b7633eDecodeMevericcoreMcdevicemqttmanager(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RPCMsg) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD2b7633eDecodeMevericcoreMcdevicemqttmanager(l, v)
}
