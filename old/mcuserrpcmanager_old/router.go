...
func (this *UserRPCRouterSt) Handle(c mccommon.ClientToServerHandleResultChannel, resource string, msg *mccommon.ClientToServerReqSt, rpcData *mccommon.RPCMsg) error {
	defer func() {
		close(c)
		if recover() != nil {
